package com.r_ware.r_openlib.fir_oversampledoscillatorexample;
...
public class FIR_OversampledOscillatorExample extends VoltageModule
//[user-inheritance]
//[/user-inheritance]
{

    public FIR_OversampledOscillatorExample( long moduleID, VoltageObjects voltageObjects )
    {
        super( moduleID, voltageObjects, "FIR_OversampledOscillatorExample", ModuleType.ModuleType_Oscillators, 1.2 );

        InitializeControls();


        canBeBypassed = false;
        SetSkin( "33ff1b4dfc9545e3af881b3d5842a61b" );
    }

void InitializeControls()
{

        textLabel1 = new VoltageLabel( "textLabel1", "textLabel1", this, "FIR OVERSAMPLED OSCILLATOR EXAMPLE" );
        AddComponent( textLabel1 );
        textLabel1.SetWantsMouseNotifications( false );
        textLabel1.SetPosition( 0, 6 );
        ...
        osFactorSwitch.SetPosition( 10, 108 );
        ...
        waveformSelectionSwitch.SetPosition( 27, 265 );
        ...
        switch( notification )
        {
            ...
            case Switch_Changed:   // doubleValue is the new switch value
            {
                if( component == osFactorSwitch )
                {
                    ...
                    {
                        m_downsampler   = new R_FIR_Downsampler(
                                R_FIR_Coeffs_Kaiser_20_24_100.getCoeffs( m_osFactor )
                                );
                    }
                    return true;
                }
